...
Additionally, the calibration of MS CTM and VFM is completed by an optimisation algorithm which is discussed in Section 4.1.2. The optimiser and the obtained parameters are also based on Excel as shown in Model_Calibration.xlsx.
